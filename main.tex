...
\begin{document}          
    ...
    \begin{abstract}
        Notre projet avait pour but l'implémenter d'un algorithme de classification incrémentale appelé VFDR, décrit dans \cite{Gama-VFDR}. Pour ce faire, nous nous sommes servis de l’API de Weka, une plate-forme d'apprentissage artificiel qui propose de nombreux algorithmes de classification. 
